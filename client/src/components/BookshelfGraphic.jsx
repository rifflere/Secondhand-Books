...
export default function BookshelfGraphic() {
  ...
  return (
    ...
    >
      ...
      {/* Top valance (dark wood overhang) */}
      ...
      {BOOKS.map((b, i) => {
        ...
        return (
          <g key={i}>
            ...
            <line
              x1={b.x + 4} y1={top + Math.round(b.h * 0.28)}
              x2={b.x + b.w - 2} y2={top + Math.round(b.h * 0.28)}
              stroke="rgba(255,255,255,0.18)" strokeWidth="1"
            />
            <line
              x1={b.x + 4} y1={top + Math.round(b.h * 0.35)}
              x2={b.x + b.w - 2} y2={top + Math.round(b.h * 0.35)}
      ...
      {/* Shelf plank */}
      <rect x="0" y={SHELF_Y} width="700" height={PLANK_H} fill="url(#plankGrad)" />
